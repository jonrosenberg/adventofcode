...
alykzandr
https://www.reddit.com/user/alykzandr/
·
10 hr. ago
...
def evaluate_options( blueprint: Blueprint, prior_states: list[State], timelimit: int = 26 ) -> list[tuple[int, list]]:
    ...
    if time_remaining >= 0:
        ...
        return max(results)
    # return most recent state goede number, prior_states
